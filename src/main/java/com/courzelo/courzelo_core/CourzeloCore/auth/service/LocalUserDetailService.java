...
import com.courzelo.courzelo_core.CourzeloCore.auth.exception.ResourceNotFoundException;
...
public class LocalUserDetailService implements UserDetailsService {
	...
	private LocalUser createLocalUser(User user) {
		return new LocalUser(user.getFollowers(),user.getFollowing(),user.getEmail(), user.getPassword(), user.isEnabled(), true, true, true, GeneralUtils.buildSimpleGrantedAuthorities(user.getRoles()), user);
	}
}
